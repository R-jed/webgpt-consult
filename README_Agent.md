...
After a verified successful consultation, update the registry with the canonical ChatGPT conversation URL, stable workstream key, task ID, scope, and one-sentence summary.
